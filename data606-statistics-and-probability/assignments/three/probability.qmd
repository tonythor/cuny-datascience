...
**Insert your answer here**
*In a shell or in RStudio, and because I set the seed, I should expect the simulation to produce the same results. It doesn't though. Every time I call the `sample` method the seed resets. Perhaps it is because I am using Visual Studio, I don't really know, but it doesn't matter.
