...
_let's have a quick look at Kobe's data..._
...
\textit{We're likely studying this data set because it does appear that if Kobe hits a second shot, he is undoubtedly going to hit a third, and therefore has a "hot hand."}

\textit{Including the graph to the right only because asked for in the question.}
