...
For the last step, we must suggest how much cash each ATM gives out.

Remembering two things, that units of cash are in 100's, and that we are using ATM1 as a proxy for ATM3, we should only have to sum the means of the forecast data sets to get a reasonable forecast for the month per atm. 

For our final numbers, we will round to the nearest 10$ bill and add commas to make those numbers easy to read.
...
*Question 1 took about 13 hours to complete*
