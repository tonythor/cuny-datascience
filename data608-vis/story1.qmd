---
title: " Story 1: Infrastructure Investment and Jobs Act Funding Allocation to Population"
...
## Conclusion
Neither of these charts demonstrates a strictly proportional relationship between state population size and money distributed for IIJA projects. For example, Alaska, with a relatively small population, receives significantly more funding than expected, potentially for reasons like infrastructure and energy projects that could impact gas prices. Several traditionally Republican-leaning states are at the top of the spending list, while Democratic-leaning states like New York and California show slight underspending relative to population. Although the reasons for this distribution are unclear without further review of individual projects, the current pattern could suggest decisions aligned with specific political or economic strategies of the Democratic administration.
